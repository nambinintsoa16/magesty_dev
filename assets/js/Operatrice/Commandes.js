...
$.post(base_url+'operatrice/newfacture',{Id_discussion:Id_discussion},function(data) {
	var fact = data.codefact;
    $.post(base_url+'operatrice/sauvemessage',{message:fact,Id_zone:id_zone,id_con:id_con,Type:'vente',sender:'OPL'},function(){
    });
$.post(base_url+'operatrice/enregistre_commande', { Id_discussion: Id_discussion,contact: contact, fact: fact,Id_zone: Id_zone ,date: date, Debut: Debut, Fin: Fin, ville: ville, quartier: quartier, lieu_de_livraison: lieulivre, remarque: remarque, produits: detailcommande, client: client,frailivre:frailivre,District:District }, function(datas) {
