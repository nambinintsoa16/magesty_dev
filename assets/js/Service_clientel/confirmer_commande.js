 ...
 $('.valider').on('click',function(event){
    ...
    $.post(base_url+'Service_clientel/livre_vente',{livreur:livreur,remarque:remarque,facture:facture,client:client},function(data){
        if(data.message){
            ...
            stopload();
            alertMessage("Succé", "Vente livrée avec succès", "success", "btn btn-success");
      ...
      if(date==""){
        ...
        $.post($(this).attr('href'),{facture:facture,date:date,fin:fin,Remarque:Remarque},function(data){
            if(data.message==true){
                stopload();
                alertMessage("Succé", "Commande repporter avec succés!", "success", "btn btn-success");
                
            }else{
                stopload();
                alertMessage("Erreur", "Ooops erreur!", "error", "btn btn-danger");
