...
$('.link').on('click',function(){ 
    ...
    loding();
    $.post(base_url+'Service_clientel/detail_vente_com',{date:date,type:type},function(data){ 
...
function  Init(){
    let date=$('.date_select').text();
    loding();
    $.post(base_url+'Service_clientel/detail_vente_com',{date:date,type:'Previ'},function(data){
           $('.panel').empty().append(data);
           Tables();
           stopload();
    });
