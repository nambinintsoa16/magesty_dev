$(document).ready(function() {
        ...
        if (link != "") {
            ...
            $.post(base_url + 'globale/testLink', { liensurfb: link, type: 'link' }, function(data) {
                if (data.exist == 'true') {
                    ...
                    $.get(base_url + "images/client/" + data.Code_client + ".jpg").done(function() {
                        $('#preview').attr("src", base_url + "images/client/" + data.Code_client + ".jpg");
                        alert(1);
                    }).fail(function() {
                        $('#preview').attr("src", base_url + "images/client/default.jpg");
    ...
    $('.save').on('click', function(event) {
        ...
        if (test == "http://magesty-old.combo.fun/images/default_user.png") {
