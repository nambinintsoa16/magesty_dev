    ...
    <div class="card-body" style="padding-top:50px;">  
      ...
      <div class="form-group" >
       ...
       <div class="form-row">
            ...
            <img class="img-thumbnail image_choise Client clientzoom" id = "cl" onclick=changeToClient() src="<?php echo(base_url("images/client/".$this->Facture_model->verifierPdp($codeClient).".jpg")) ?>" alt="Client " style="border-radius:50%;width:60px;height:60px;margin:10px;" >
            </div>
            <div class="col-md-6" style="min-height: 40px" > 
         ...
         <div class="row" style="padding-left: 10px;">
            <div class="col-md-12" style="padding: 0px 5px;">
              <div class="entetebadge" style="background:#33b5e5;border-radius: 5px;min-height: 50px;padding: 3px 0px;">
                ...
                <img class="img-thumbnail Client" id= "clImg" src="<?php echo(base_url("images/client/".$this->Facture_model->verifierPdp($codeClient).".jpg")) ?>" alt="client"  style="border-radius: 50%;width:50px;height:50px;margin-left:20px; ">&nbsp;<span class="code_client_ban" style="color:#000"></span> <span style="color: #000;"></span> <span class="nom_client_ban " style="color:#000;margin:auto"><p id="nomDuClient"><?php echo($nomClient."  ".$codeClient); ?></p></span> 
                  ...
                  <?php
                      ...
                      foreach($resultfact as $value){?>
                        ...
                        <div style="padding:8px 5px" class = "classeClient" >
                          ...
                          <?php
                            $sql  = $this->db->query("SELECT * FROM `client` WHERE `Code_client` like '$value->Code_client'");
                            $clientresult = $sql->result();
                            if(empty($clientresult)){
                              $sql  = $this->db->query("SELECT * FROM `clientpo` WHERE `Code_client` like '$value->Code_client'");
                              $clientresult2 = $sql->result();
                              if(empty($clientresult2)){
                                $sql  = $this->db->query("SELECT * FROM `client_curieux` WHERE `Code_client` like '$value->Code_client'");
                                $clientresult3 = $sql->result();
                                foreach( $clientresult3 as  $clientresult3){
                                  $color = "gray" ;
                                  if($clientresult3->Code_client == $codeClient)
                                  {
                                    $color = "blue" ;
                                  }
                                  ?>
                                  <img src="<?php echo(base_url("images/client/".$this->Facture_model->verifierPdp($value->Code_client).".jpg")) ?>" class="img-thumbnail client_lat" id ="<?php  echo($value->Code_client);?>" style="height:30px;width:30px;cursor:pointer;border-color:<?php echo($color) ; ?>;" >
                              ...
                              <?php
                                ...
                                foreach( $clientresult2 as  $clientresult2){
                                  ...
                                  $color = "gray" ;
                                  if($clientresult2->Code_client == $codeClient)
                                  {
                                    $color = "blue" ;
                                  }
                              ...
                              foreach( $clientresult as  $clientresult){
                                ...
                                $color = "gray" ;
                                  if($clientresult->Code_client == $codeClient)
                                  {
                                    $color = "blue" ;
                                  }
                                ?>
                              ...
                              <?php echo$code =  $clientresult->Nom ." ".  $clientresult->Prenom;
                              }
