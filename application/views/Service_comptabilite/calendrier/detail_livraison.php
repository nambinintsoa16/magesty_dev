  ...
  <div>
      <a href="<?=base_url('service_clientel/calendrier/detail_livraison_koty/'.$date)?>" class="btn btn-primary btn-lg">Livraison Tsena Koty</a>
  </div>
  <hr class="">
  ...
  <div class="row ml-3">
      ...
      <div class="col-md-2 col-sm-6 col-xs-12 link" id="livre" style="padding-right:30px;cursor:pointer">
          <div class="row">
              ...
              <div class="col-md-8" style="background:white;color:#ddd;height:70px">
                  <p class="" style="color:black;font-size:12px;padding-top:10px">Livraisxons Réalisées <br>
