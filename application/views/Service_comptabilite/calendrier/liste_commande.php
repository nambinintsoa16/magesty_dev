    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                 ...
                 <?php 
                 if($type=='livre'){
                  echo base_url('Service_comptabilite/confirmer_commande/'.$data['facture']);
                 }else if($type=='en_attente'){
                  echo base_url('Service_comptabilite/planifier_commande/'.$data['facture']);
                 }else{
                   echo base_url('Service_comptabilite/detail/'.$data['facture']);
                 }
