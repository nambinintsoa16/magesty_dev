     ...
     <div class="col-md-12">
         <div class="col-md-12 text-white">
             <a class="btn btn-success m-1 pull-right " data-toggle="modal" data-target="#myModallivre"> <span
                     style="background:green;height:100%;width:150px;"></span>Verser </a>
             <a class="btn btn-danger m-1 pull-right " data-toggle="modal" data-target="#myModal"><span></span>
                 Annuler</a>
             <a href="fonction/class/dompdf/factureone.php?NumFact=" class="btn btn-primary m-1 pull-left ">
                 Imprimer facture</a>
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             <div class="modal-header bg-danger">
                 <h5 class="modal-title">Annullée la commande de <?=$client->Nom." ".$client->Prenom?></h5>
     ...
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <div class="modal-footer">
                 ...
                 <a data-dismiss="modal" href="#" class="btn btn-success pull-right Verser">valider</a>
