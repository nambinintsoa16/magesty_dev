        ...
        <div class="col-xs-3 col-sm-3">
            ...
            <div class="profile-user-info">
                ...
                <div class="profile-info-row">
                    <div class="row">
                        <div class="form-groupe  col-md-8 mt-2">
                            <input type="text" class="form-control form-control-sm fraisRetrait" disabled value="<?= ($client->frais_de_retrait == " ") ? 0 : $client->frais_de_retrait ?>">
                        </div>
                ...
                <div class="profile-info-row">
                    <div class="row">
                        <div class="form-groupe  col-md-8 mt-2">
                            <input type="text" class="form-control form-control-sm fraisInput" disabled value="<?= ($client->frais == " ") ? 0 : $client->frais ?>">
                        </div>
                        <div class="form-groupe  col-md-4 mt-2 p-0">
                            <a href="#" class="btn btn-warning modifrais btn-sm w-100 p-1" id="<?= $client->id ?>"><i class="fa fa-edit"></i>&nbsp; Frais</a>
                        </div>
