<div class="row">
    <div class="form-group col-md-10 text-right pr-5">
        <a href="<?= base_url('operatrice/printdataTombola') ?>" class="btn btn-success"><i class="flaticon-inbox"></i> EXPORT</a>
    </div>
    <div class="form-group col-md-2 text-right pr-5">
       
        <a href="#" class="btn btn-primary actualiser"><i class="flaticon-repeat"></i> &nbsp;ACTUALISER</a>
    </div>
