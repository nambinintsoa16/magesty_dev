<div class="col-md-12 responsive" style="height:650px!important;overflow: scroll;">
            <table class="table dataTable table-striped table-advance table-hover" id="tableau" >
              <thead>
               ...
               <td><img src="<?=code_client_img_link($data['code_client'])?>" width="50" height="50px" style="border-radius: 50%"></td> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
              ...
              <br>
                <a href="<?=base_url('service_clientel/export/'.$date.'/'.$type)?>"  class="btn btn-success btn-sm print pull-right" style="margin-left:25px"><i class="fa fa-download" aria-hidden="true"></i>&nbsp;Exporter</a>
                <a href="#"  class="btn btn-primary btn-sm print pull-right" style="margin-left:25px"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Imprimer</a> 
              <br>
