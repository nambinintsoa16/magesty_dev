  ...
  <div class="row">
    <div class="col-xs-5 col-sm-4  text-center">
      <span class="profile-picture">
        <img alt="<?= $client->Code_client ?>" class="simple img-thumbnail" src="<?= code_client_img_link($client->Code_client) ?>" style="height:160px;width:160px;">
      </span>
    ...
    <div class="col-xs-3 col-sm-3">
      <div style="overflow:hidden;width: 400px;height: 200px;"><iframe width="350" height="400" src="https://maps.google.com/maps?width=350&amp;height=400&amp;hl=en&amp;q=%20%09<?= $client->Quartier ?>%20%2C%20<?= $client->Quartier ?>%20%2C<?= $client->Ville ?>%2Cmadagascar+(Titre)&amp;ie=UTF8&amp;t=k&amp;z=17&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
        <div><small><a href="https://embedgooglemaps.com/en/">embedgooglemaps FR</a></small></div>
        <div><small><a href="https://newyorkhoponhopoffbus.nl">new york city freestyle pass: hop-on, hop-off tour en ferry</a></small></div>
        <style>
          #gmap_canvas img {
...
<table class="table table-striped table-advance table-hover table-bordered" style="margin-top: 60px;">
  ...
  <tr>
      <th style="text-align: center; color: #fff; border-left: 1px solid #fff;width: 250px;"> Nom du livreur</th>
      <th style="text-align: center; color: #fff; border-left: 1px solid #fff; width: 200px"> Date de livraison</th>
      <th style="text-align: center; color: #fff; border-left: 1px solid #fff;width: 267px;"> Heure de livraison </th>
...
<table class="table" style="border-top:solid 1px #dbdbdb;border-bottom:solid 1px #dbdbdb; margin-top: 10px;">
  <thead  class="bg-danger">
    <tr>
      ...
      <th style="text-align: center;color: #fff; border-left: 1px solid #fff;width: 200px">Prix en Ariary</th>
      <th style="text-align: center;color: #fff; border-left: 1px solid #fff;width: 267px;">Quantite</th>
  ...
  <tbody class="tbody">
    <?php $total = 0;
    foreach ($commande as $commande) : if ($commande->statut != 'annuler') : ?>
        <tr>
          <td style="text-align: center;">
            <a href="<?= base_url('images/produit/' . $commande->Code_produit) ?>.jpg" data-lightbox="roadtrip"><?= $commande->Designation ?></a>
          </td>
          <td style="text-align: center;"><?php echo  number_format($commande->Prix_detail, 2, ',', ' '); ?></td>
          <td style="text-align: center;"><?= $commande->Quantite ?></td>
          <td style="text-align: center;" class="total"><?php $total += $commande->Prix_detail * $commande->Quantite;
                                                        echo number_format($commande->Prix_detail * $commande->Quantite, 2, ',', ' '); ?></td>
          <td style="text-align: center;">
