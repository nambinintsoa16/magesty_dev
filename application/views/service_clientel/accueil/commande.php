  ...
  <div class="progress-bar progress-bar-primary" role="progressbar" style="width:40%">
    Blue
  </div>
  <div class="progress-bar progress-bar" role="progressbar" style="width:30%;background-color: orange;">
    Orange
  </div>
...
<fieldset class="border p-2">
   <legend  class="w-auto">Produit</legend>   
      ...
      <div class="col-lg-3">
       ...
       <select class="form-control groupe" name="codeproduit" placeholder="Cathegory">
  ...
  <div >
      <div class="form-group ">
        <label for="cemail" class="control-label col-lg-2">Quartier<span class="required" Buttom="disable"> *</span>
        </label>
          <div class="col-lg-10"  style="margin-bottom: 10px!important">
            <input class="form-control Quartier" id="Quartier" type="text" name="livraison"  />
          </div>
      </div>
      <div class="form-group " style="margin-top: 5px">
        ...
        <label for="cemail" class="control-label col-lg-2">Ville<span class="required"> *</span>
          ...
          <div class="col-lg-10" style="margin-bottom: 10px!important">
            <input class="form-control Ville" id="Ville" type="text" name="Ville"  />
          </div> 
        </div>
          <div class="form-group " style="margin-top: 5px">
        <label for="cemail" class="control-label col-lg-2">District<span class="required"> *</span>
          ...
          <div class="col-lg-10"  style="margin-bottom: 10px!important">
            <input class="form-control District" id="District" type="text" name="District"/>
          </div>       
      </div>      
    
      <div class="form-group " style="margin-top: 5px">
                         <label for="cname" class="control-label col-lg-2">Frais <span class="required">*</span>
                         </label>
                      <div class="col-lg-10" style="margin-bottom: 10px!important">
    ...
    <button type="submit" class="btn btn-primary pull-right btn-test" style="margin-top:30px;margin-right:20px">Valider la commande</button>
                   ...
                   <div class="upload-btn-wrapper" style=" position: relative;overflow: hidden;display: inline-block; margin-top:10px;">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="form-group  col-lg-4">
                        <input class=" form-control" id="idvp" name="idvp" type="text"/>
                      </div>
