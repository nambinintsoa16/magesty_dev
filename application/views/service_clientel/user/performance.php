...
<div class="container col-md-12">
    <div class="row">
        <div class="col-md-12">
            ...
            <div style="z-index:0;margin-top:-330px;position:absolute;color:white;font-size:26px;padding-left:50px;">
                 <img src="<?=base_url('images/'.strtolower($type_user)."/PhotoUser"."/".$this->session->userdata('matricule'))?>.jpg" class="style-image"
                    style="position:relative;border-radius:50%;margin-top:20px;border:solid 5px #fff;width:150px;height:150px;">
                <br><br>
            </div>
            <div class="row" style="margin-top:-50px;">
                <div class="col-md-3 col-sm-6 col-xs-12 link" style="padding-left:30px; padding-right:30px;border-radius: 5px !important;" id="vente">
                    <a href="#" class="nav-link">    
                        <div class="row">
                            <div class="col-md-4" style="height:80px;background:#01aad3  !important">
                                <div class="info-box-icon" style="background:#0180a9;border-radius:50%;width:50px;height:50px;margin-top:15px;">
                                    <i class="fa fa-shopping-cart" style="font-size:22px;color:white;padding-top:15px;padding-left:15px;"></i>
                                </div>
                            </div>
                            <div class="col-md-8 bleu" id="bleue" style="height:80px;background:#01aad3 !important;padding-top:10px;color:white;">
                    ...
                    <a href="#" class="nav-link">
                        <div class="row">
                            <div class="col-md-4 "  style="height:80px;background:#fc7184 !important;">
                                <div class="info-box-icon" style="background:#ce5866;border-radius:50%;width:50px;height:50px;margin-top:15px;">
                                    <i class="fa fa-edit" style="font-size:22px;color:white;padding-top:15px;padding-left:15px;"></i>
                                </div>
                            </div>
                            <div class="col-md-8 orange" id="orangee" style="height:80px;background:#fc7184 !important;padding-top:20px;color:white;">
                                <span class="info-box-text">Produit vendu</span><br>
                                <span class="info-box-number"><?= is_null($data->Produit_vendue) ? 0 : $data->Produit_vendue ?></span>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="#" class="nav-link">
                        <div class="row">
                            <div class="col-md-4" style="height:80px;background:#feab41 !important">
                                <div class="info-box-icon" style="background:#d2762d;border-radius:50%;width:50px;height:50px;margin-top:15px;">
                                    <i class="fa fa-users" style="font-size:22px;color:white;padding-top:13px;padding-left:13px;"></i>
                                </div>
                            </div>
                            <div class="col-md-8 jaune" id="jaunee" style="height:80px;background:#feab41 !important;padding-top:20px;color:white;">
                ...
                <a href="#" class="nav-link">
                    <div class="row">
                        <div class="col-md-4" style="height:80px;background:#28af6a  !important">
                            <div class="info-box-icon" style="background:#209761;border-radius:50%;width:50px;height:50px;margin-top:15px">
                                <i class="fa fa-cubes" style="font-size:22px;color:white;padding-top:13px;padding-left:13px"></i>
                            </div>
                        </div>
                        <div class="col-md-8 vert" id="verte" style="height:80px;background:#28af6a  !important;padding-top:20px;color:white">
                            <span class="info-box-text">Vente du jour</span><br>
                            <span class="info-box-number"><?=number_format($data->ventedujou, 2, ',', ' ');?> Ar</span>
                        </div>
                    </div>
                    </a>
                </div>
    ...
    <div class="col-md-12" style="background:white;margin:15px 0px;">
        <div class="row" style="margin-top:10px;">
            <div class="col-md-8">
                <a href="fonction/class/dompdf/venteconfirmerexporte.php"  class="btn btn-success print" ><i class="fa fa-download"></i>&nbsp;Exporter</a>
            </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content"> 
                    ...
                    <table class="table table-bordered table-bordered-bd-info" id="table">
                     ...
                     <?php  foreach ($client as $key => $client) : ?>
                            <tr>
                                ...
                                <td><a href="<?=$client->lien_facebook?>" target="_blank"><i class="fa fa-facebook"></i></a></td>
            ...
            <div class="modal-footer">
                <a href="fonction/class/dompdf/printventeprobyuser.php?user="  class="btn btn-primary export" >Imprimer</a>
                <a href="exporterprobyuser.php?user="  class="btn btn-success print" >Exporter</a>
