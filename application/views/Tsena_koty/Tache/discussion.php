    ...
    <div class="row m-1">
        ...
        <div class="bg-red mt-2" style="width:25%;">
            <div class="card text-center" style="height:750px;">
                <div class="card-header" style="background:#FF4081;">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="form-group col-md-12 p-auto">
                            ...
                            <div class="row">
                                <div class="file-upload btn btn-sm btn-info mt-2 m-2 col-md-3">
                                    <span class=""><i class="fas fa-paperclip"></i></span>
                                    <input type="file" id="CLT" class="PJ form-control-file w-100" />
                                </div>
                                <div class="col-md-3 p-0">
                                    <button class="btn btn-sm btn-warning valide_content blockerSiNouveau mt-2 p-0 w-100" data-toggle="tooltip" data-placement="top"><i class="fa fa-support"></i></button>
                                </div>
                                <div class="col-md-4 p-0">
                                    <button class="btn btn-sm btn-success pull-right valide_content blockerSiNouveau ml-5 mt-2 p-0 w-75"><i class="fa fa-check" aria-hidden="true"></i></button>
                                </div>
                                <div class="col-md-12 text-center p-0">
                                    <a href="#" class="lien w-100 btn btn-secondary " data-toggle="modal" data-target="#promokoty">PRODUITS DISPONIBLES</a>

                                    <div class="modal fade" id="promokoty" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header" style="background:#FF4081;color:#fff;">
                                                    <h5 class="modal-title" id="exampleModalLongTitle"><b>PRODUITS
                                                            DISPONIBLES</b></h5>
                                                ...
                                                <div class="modal-body">
                                                    <table class="table table-bordered table-striped tablePromokoty w-100">
                                    ...
                                    <button type="button" class="btn mt-2 w-100" style="background-color: #FF4081;color:#fff;" data-toggle="modal" data-target="#achat">
                                        Historique d'achat
                                    </button>

                                    <!-- Modal -->
                                    <div class="modal fade" id="achat" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header" style="background:#FF4081;color:#fff;">
                                                    <h5 class="modal-title" id="exampleModalLongTitle"> <b> Historique
                                                            d'achat</b> </h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                ...
                                                <div class="modal-body">
                                                    <table class="table m-0 table-sm table-striped table-bordered">
                                                        <thead style="background:#FF4081;color:#fff;height: 50px!important;">
                                                            <tr>
                                                                <td>Date</td>
                                                                <td>Facture</td>
                                                                <td>Montant</td>
        ...
        <div class="mt-2 ml-1" style="width:74%;">
            <div class="card" style="height:750px;">
                <div class="card-header entetebadge text-white p-1" style="background:#FF4081!important;">
                    <img class="avatar-img rounded-circle Client" style="width:46px;height:46px;" src="<?= base_url("/images/default_user.png") ?>" alt="client">
                    ...
                    <div class="row justify-content-between ">
                        ...
                        <div class="col-md-4 p-3 scrolling-wrappe" style="overflow:scroll-Y;width: 650px;">
                            <div class="mb-2 p-2 scrolling-wrappe" style="overflow:scroll; height:550px;">
                                <div class="row card pt-1 pb-3 w-100 bg-white">
                                    <div class="col-md-12 p-auto text-center">
                                        <img src="<?= user_img_link($this->session->userdata('matricule')) ?>" class="img img-thumbnail Client responsive" style="width:100px;height:150px;">
                                        <p class="text-center nom_client_ban "></p>
                                    </div>

                                    <div class="col-md-12 p-0">
                                        <p class="text-center ">
                                            <?= $this->global_model->getclientstatuttrimes($smiles) ?> |
                                            <?= $this->global_model->getclientstatutAnnuel($smiles) ?></p>
                                    ...
                                    <div class="btn-image col-md-12 mt-2 p-0">
                                        <button type="button" class="btn btn-sm btn-primary majprofil w-100">Mise à jour
                                            du profil</button>
                                        <p class="text-center text-white border mt-2" style="background:#FF4081 ;">KOTY
                                            DISPONIBLES
                                        <p class="text-center" style="padding:5px 10px; font-size: 17px;">
                                            <b><?php if ($kotydispo != "") {
                                                    echo "<span class='tablePromo'>$kotydispo->Koty</span>";
                                                } else {
                                                    echo "<span class='tablePromo'>0</span>";
                                                } ?>
                                                &nbsp Koty</b>
                                        </p>
                                        </p>
                                ...
                                <div class="row card pt-1 pb-3 w-100">
                                    <div class="col-md-12 p-0">
                                        <p class="text-center text-white border" style="background:#FF4081 ;">PROMOTIONS
                                        </p>

                                        <div id="carouselExampleControl" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner">
                                                <?php $i = 0;
                                                foreach ($MesPromotion as $key => $MesPromotion) : ?>
                                                    <?php if ($i == 0) : ?>
                                                        <div class="carousel-item active" style="height: 150px!important;">
                                                            <img class="d-block w-100 images img-thumbnail image-promo" style="max-width: 100%;max-height: 100%;" src="<?= base_url('assets/images/promotion/' . $MesPromotion->codePromo . '.jpg'); ?>" alt="<?= $MesPromotion->Id_facture ?>" id="<?= $MesPromotion->codePromo ?>">
                                                        </div>
                                                    <?php else : ?>
                                        ...
                                        <div class="col-md-12 text-center p-0 mt-2">
                                            <ul class="liste-prod list-group text-center border m-0 w-100">
                                                <li class="list-group-item active text-center" aria-current="true" style="background-color:#FF4081;"> <a href="#" class="lien text-white" data-toggle="modal" data-target=".bd-example-modal-lg">SELECTIONS</a></li>
                                                <?php foreach ($produit as $key => $val) : ?>
                                                    <li class="list-group-item text-center  list-group-item-action"><a href="<?= base_url('assets/images/promotion/' . $val->Code_produit . '.jpg'); ?>" data-lightbox="roadtrip"><?= $val->Code_produit ?> </a></li>
                                                <?php endforeach ?>
                                            </ul>
                            ...
                            <div class="col-md-10">
                                <div style="margin-top: 10px;">
                                    <button class="pull-right btn btn-primary btn-sm scrolldown blockerSiNouveau" style="font-size:24px;margin-right: 5px;z-index: 9999;margin-top: -480px;padding: 6px 11px;font-size: 12px;line-height: 1.5;border-radius: 25px;border:solid 2px #33b5e5">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header text-white" style="background-color:#FF4081;">
                    <h5 class="modal-title text-uppercase" style="test-align:center;width:100%;" id="exampleModalLabel">
                        <b>Enregistrement commande tsena koty</b>
                    </h5>
                ...
                <div class="modal-body shadow" style="background:#EEEEEE!important">
                    ...
                    <fieldset class="border p-2" style="padding:2px; border: solid #FF4081 1px!important;">
                        ...
                        <div class="form-group d-flex" style="margin-bottom: 20px!important">
                            <div class="col-lg-3">
                                <select class="form-control famille form-control-sm custom-select" name="famille" placeholder="Cathegory">
                                    <option value="76">TSENA KOTY</option>
                                </select>
                            </div>
                            <div class="col-lg-3 ">
                                <select name="codeproduit" class="form-control groupe form-control-sm custom-select"></select>
                            </div>
                            <div class="col-lg-4">
                                <select name="" class="produitname form-control form-control-sm custom-select w-100" id="recherche"></select>
                            </div>
                            <div class="col-lg-0">
                                <select class="form-control zone collapse form-control-sm custom-select" name="zone" placeholder="Prix appliquer">
                            ...
                            <div class="col-lg-2">
                                <button class="btn btn-success btn-sm validproduit w-100" ><i class="flaticon-add"></i>&nbsp;Ajouter</button>
                            </div>
                        </div>
                        <hr />
                        <div class="row mt-2 p-0 ">
                            <div class="col-md-12">
                                <div class="table-responsive p-0 m-0">
                                    <table class="table table-striped table_commande table-bordered border-white table-sm">
                                        <thead class="text-white" style="background-color: #FF4081;">
                                            <tr>
                                                <th>Code produit</th>
                                                <th>Désignation</th>
                                                <th>Prix Unitaire</th>
                                        ...
                                        <tfoot style="border:1px solid rgba(0,0,0,.1)">
                                            <tr>
                                                ...
                                                <td colspan="3" class="font-weight-bold">
                                                    Sous total : &nbsp; &nbsp;<b><label class="total">00
                                                            KOTY</label></b>
                                                </td>
                                                <td></td>
                                            </tr>
                    ...
                    <fieldset class="border p-2 pr-4" style="padding:2px; border: solid #FF4081 1px!important;">
                        <legend class="w-auto">Livraison</legend>
                        <div class="col-md-12 mt-1 w-100 p-0">
                            <div class="row col-md-12 m-auto p-0 border">
                                <div class="form-group col-md-4">
                                    <label for="contact" class="control-label col-lg-2">Contact<span class="required">
                                            *</span></label>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control form-control-sm custom-select Localite ">
                        ...
                        <div class="col-md-12 mt-1 w-100 p-0">
                            <div class="row col-md-12 m-auto p-0 border">
                                ...
                                <div class="col-md-4 form-group">
                                    <label class="control-label" for="inputSuccess">Début<span class="required">
                                            *</span></label>
                                    <input type="time" class="form-control Debut form-control-sm " min="09:00" max="17:00" />
                                </div>
                                <div class="col-md-4 form-group">
                                    <label class="control-label" for="inputSuccess">Fin<span class="required">
                                            *</span></label>
                        ...
                        <div class="col-md-12 mt-1 w-100 p-0">
                            <div class="row col-md-12 m-auto p-0 border">
                                <div class="form-group col-md-4">
                                    <label for="cemail" class="control-label col-lg-2">Quartier<span class="required">
                                            *</span></label>
                                ...
                                <div class="form-group col-md-4">
                                    <label for="cemail" class="control-label col-lg-2">Ville<span class="required">
                                            *</span></label>
                        ...
                        <div class="col-md-12 mt-1 w-100 p-0">
                            <div class="row col-md-12 m-auto p-0 border">
                                <div class="form-group col-md-4">
                                    <label for="cemail" class="control-label col-lg-2">Zone<span class="required">
                                            *</span></label>
                                    <input class="form-control zone form-control-sm" id="zone" disabled type="text" name="zone" />
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="cemail" class="control-label col-lg-2">Axe<span class="required">
                                            *</span>
                                    </label>
                        ...
                        <div class="col-md-12 mt-1 w-100 p-0">
                            <div class="row col-md-12 m-auto p-0 border">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control fraisderetrait form-control-sm" id="fraisderetrait" type="number" required="" onKeyUp="javascript:this.value=this.value.toUpperCase();" name="fraisderetrait" />
                                </div>
                            </div>
                        </div>
            ...
            <fieldset>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            <label class="control-label" for="inputSuccess">Date: <span class="required">
                                    *</span></label>
                            <input type="date" class="form-control daterdv form-control-sm" />
                        </div>

                        <div class="form-group col-md-4">
                            <label class="control-label" for="inputSuccess">Heure: <span class="required">
                                    *</span></label>
                            <input type="time" class="form-control heurervd form-control-sm" min="08:00" max="16:00" />
                        </div>
                        <div class="form-group col-md-4">
                            <label>Contact :</label>
                            <input type="tel" id="contact" name="contact" class="form-control contactRvd form-control-sm" placeholder="+261 33 32 123 12" pattern="[0-9]{3}[0-9]{2}[0-9]{3}[0-9]{2}" required minlength="10" maxlength="10">
                        </div>
                        <hr />

                        <div class="form-group col-md-12 text-rigth">

                            <select class="form-control produiRV w-100 custom-select">
            ...
            <div class="modal-body">
                <div class="container autreinpp">
                    <div class="row">
                        <div class="card">
                            <div class="card-body text-center" style="padding:10%;">
                                ...
                                <div class="form-group">
                                    <input id="liensurfb" class="form-control form-control-sm" type="text" name="" placeholder="LIEN Facebook">
                                </div>
                                <div class="form-group">
                                    <input id="identifient" class="form-control form-control-sm" type="text" name="" placeholder="ID Facebook">
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <input id="identifient" class="form-control coach form-control-sm" type="text" name="" placeholder="Coach">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <input id="identifient" class="form-control commerciale form-control-sm" type="text" name="" placeholder="Commerciale">
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="#" class="btn btn-success pull-right save"><i class="fa fa-plus-circle bg-gray"></i>
                            Enregistrer</a>
